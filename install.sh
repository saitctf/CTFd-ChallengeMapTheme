...
echo ""
echo "Features:"
echo "- Interactive Canada map with challenges mapped to provinces/territories"
echo "- Color-coded categories with legend"
echo "- Real-time challenge solve tracking"
echo "- Responsive design for all devices"
echo ""
echo "To assign challenges to specific provinces/territories, add province tags to your challenges:"
echo "- Tag: 'BC' → Challenge appears on British Columbia"
echo "- Tag: 'ON' → Challenge appears on Ontario"
echo "- Tag: 'QC' → Challenge appears on Quebec"
echo "- Tag: 'AB' → Challenge appears on Alberta"